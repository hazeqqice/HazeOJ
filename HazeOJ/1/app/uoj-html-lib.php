...
function getSubmissionStatusDetails($submission) {
	...
	$fly = '<img src="http://hazeoj.ngrok.cc/pictures/talk.gif" alt="批判一番" class="img-rounded" />';
	$think = '<img src="http://hazeoj.ngrok.cc/pictures/clap.gif" alt="长者鼓掌" class="img-rounded" />';
