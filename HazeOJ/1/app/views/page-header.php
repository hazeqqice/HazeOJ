...
<html lang="<?= UOJLocale::locale() ?>">
	<head>
		...
		<!-- UOJ ico -->
		<link rel="shortcut icon" href="<?= HTML::url('/pictures/HazeOJ.ico') ?>" />
	...
	<body role="document">
		<div class="container theme-showcase" role="main">
			...
			<div>
				...
				<h1 class="hidden-xs"><a href="<?= HTML::url('/') ?>"><img src="<?= HTML::url('/pictures/HazeOJ_small.png') ?>" alt="UOJ Logo" class="img-rounded" style="width:39px; height:39px;" /></a> <?= $PageMainTitle ?></h1>
